...
<!-- 
<?php echo $__env->make('frontend.components.login_register_modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
 -->
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> 
<script src="<?php echo e(URL::asset('public/frontend/js/loadingoverlay.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('public/frontend/js/loadingoverlay_progress.min.js')); ?>"></script> 
