<?php $__env->startSection('title', 'Add New Finance'); ?>
		...
		<div class="x_panel">
		  <div class="x_title">
		   ...
		   <div class="x_content">
			...
			<?php endif; ?>
			<br />
			<form id='registrationForm' action="<?php echo e(url('admin/finance/create')); ?> "  class="form-horizontal" method='post' enctype="multipart/form-data">
