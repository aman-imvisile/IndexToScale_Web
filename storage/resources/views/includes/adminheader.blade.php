              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="javascript:void(0)"><i class="fa fa-money"></i> Finances <span class="fa fa-chevron-right"></span></a>
                    <ul class="nav child_menu">
                    	<li class="add-btn"><a href="{{url('admin/finance/create')}}" class="btn btn-primary">Add Finance</a></li>
                    	<li><a href="{{url('admin/finance/list/1')}}">Subscription packages</a></li>
						<li><a href="{{url('admin/finance/list/2')}}">Pay Per Click Rate</a></li>
  						<li><a href="{{url('admin/finance/list/3')}}">Indexing Money for Users</a></li>
                    </ul>
                  </li>
