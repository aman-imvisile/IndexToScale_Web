	  ...
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  ...
		  <div class="x_content">
			...
			@endif
			<br />
			<form id='registrationForm' action="{{url('admin/userType/update')}} "  class="form-horizontal" method='post'>
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
            	<div class="item col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
            	<input type="hidden" value="{{$userType[0]->id}}" name="id">
            		<label for="type_name">User Type</label>
					<input type="text" class="form-control" value="{{$userType[0]->usertype_name}}" name='usertype_name' id="inputSuccess2" placeholder="User Type" >
				</div>
